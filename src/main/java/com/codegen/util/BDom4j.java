...
public class BDom4j {
    ...
    private HashMap<String, String> m_xmlMap = null;//xsd命名空间,可以有多个。
    ...
    public void openXML(Document doc) throws Exception {
        ...
        if ((uri != null) && (uri.length() > 0)) {
            m_xmlMap = new HashMap<String, String>();
    ...
    private String changeXpathWhenNameSpace(String specName) {
        ...
        String[] segs = StringUtils.split(specName, "/");
    ...
    public static Element addElementInSpecEle(Element parentEle, String eleName,
            String eleText, Map<String, String> attributes) {
     ...
     * @param nodeValue 节点值
     */
    public Element addNodeFromRoot(String nodeName, String nodeValue, Map<String, String> attributes) {
